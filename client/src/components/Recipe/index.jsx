      ...
      <section style={{ height: '50vh', width: '90vw' }} className=" bg-orange-100 rounded shadow-md relative">
        ...
        {addRecipeShown && (
          <div className=" flex flex-wrap items-center justify-center  bg-white p-4">
            ...
            <button className="btn" onClick={addIndredientInput}>
              Save
            </button>
            <div className="w-full flex flex-wrap">
              {ingredientData.map(item => (
                <div className="w-1/2 sm:w-1/3 md:w-1/5">
                  <ShowIngredient className="" ingredientData={ingredientData} setIngredientData={setIngredientData} itemData={item} />
                </div>
              ))}
            </div>
